    ...
    <div class="add-recipe-modal">
        <div class="modal-frame">
          ...
          <div class="top-section">
            <p class="section-heading add-recipe-heading">ADDING NEW RECIPE</p>
            <a href="#" class="close_button close_add_rec">
              <img class="save_button-icon" src="/public/icons/darker/close-darker.svg" />
            </a>
          </div>
          ...
          <button class="primary-btn add-recipe-button">ADD NEW RECIPE</button>
